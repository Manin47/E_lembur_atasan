    ...
    <!-- Main content -->
      <div class="container">
           <h1>  Edit </h1>
            ...
            <form enctype="multipart/form-data" action="{{ url('update-data-gambar') }}/{{ $data->id}}" method="post">
            {{ csrf_field() }}
                ...
                <div class="form-group">
                    ...
                    <input type="file" class="form-control" id="foto" name="file" required="" value="{{ $data->file }}">
                </div>
                <div class="form-group">
