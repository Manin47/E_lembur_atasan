...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
       ...
       <form  method="POST" action="{{ route('simpan-data-lembur-pertama') }}">
       @csrf
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control"  name="nik_karyawan_foregin" value="{{ auth()->user()->nik_user }}" readonly>
            </div>
          </div>
          
          <!-- <div class="form-group row">
                <label for="department" class="col-sm-2 col-form-label"  > NIK Karyawan </label>
                <div class="col-sm-10">
                    <select name="nik_karyawan_foregin" class="form-control"> 
                      @foreach ($data as $ini)
                          <option  selected="selected"> {{ $ini->nik_user }}</option>
                      @endforeach
                    </select>
                </div>
              </div> -->
           ...
           <div class="form-group row">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select name="hari_lembur" class="form-control"> 
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control"  name="alasan_lembur">
            </div>
          </div>
          ...
          <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select name="mulai_dari_jam" class="form-control"> 
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="number" class="form-control"  name="total_jam" max="8" min="1">
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control"  name="insentif" >
                </div>
              </div>
           

              <div class="form-group row">
                <label for="department" class="col-sm-2 col-form-label"  > Atasan  </label>
                <div class="col-sm-10">
                    <select name="atasan" class="form-control"> 
                      <option value='spv_produksi_g1' selected="selected"> Andi </option>
                      <option value='spv_produksi_g2'> Budi </option> 
                      <option value='spv_produksi_g3'> Citra </option> 
                      <option value='spv_maintenance'> Dede </option> 
                      <option value='spv_logistic'> Elis </option> 
                      <option value='spv_qc_inline'> Fanda </option> 
                      <option value='spv_qc_analist'> Gita </option> 
                      <option value='spv_gal'> Herman </option> 
